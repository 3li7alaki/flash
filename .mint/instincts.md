...
|----------|---------|-----------|------------|--------------|
| naming | camelCase-functions | types.test.ts, serializer.test.ts, parser.test.ts, serial... | 247 | 2026-03-21 |
| tests | describe-it-pattern | types.test.ts, serializer.test.ts, parser.test.ts, linter... | 67 | 2026-03-21 |
| tests | expect-assertions | types.test.ts, serializer.test.ts, parser.test.ts, linter... | 67 | 2026-03-21 |
