...
|----------|---------|-----------|------------|--------------|
| naming | camelCase-functions | types.test.ts, serializer.test.ts, parser.test.ts, serial... | 137 | 2026-03-21 |
| tests | describe-it-pattern | types.test.ts, serializer.test.ts, parser.test.ts, linter... | 49 | 2026-03-21 |
| tests | expect-assertions | types.test.ts, serializer.test.ts, parser.test.ts, linter... | 49 | 2026-03-21 |
